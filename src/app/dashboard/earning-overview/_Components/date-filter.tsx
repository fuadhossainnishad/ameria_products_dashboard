...
export const DateFilter: React.FC<DetailsModalProps> = ({ onApply, onReset, children }: FilterDialogProps) => {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-80 top-76 right-8 left-auto translate-x-0 translate-y-0">
                <DialogHeader>
